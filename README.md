...
## Overview
  ...
  The player has to be quick in guessing, however, since there are only 5-seconds per round. Get a round wrong and you lose. Get a round right, however, and you will recieve points based on the difficulty level of the word. 
